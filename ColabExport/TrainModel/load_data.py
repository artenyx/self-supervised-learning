...
def get_CIFAR100(config, CIFAR100_train=None, CIFAR100_test=None):
    ...
    CIFAR100_train_loader = torch.utils.data.DataLoader(CIFAR100_train, batch_size=batch_size, shuffle=True, num_workers=1)
    CIFAR100_test_loader = torch.utils.data.DataLoader(CIFAR100_test, batch_size=batch_size, shuffle=True, num_workers=1)
