...
plots.plot_usl(config, usl_data_ae_s_d, 'ae_s_den_')
plots.plot_lineval(config, le_data_ae_s_d, 'ae_s_den_')
...
plots.plot_usl(config, usl_data_ae_s_nd, 'ae_s_nonden_')
plots.plot_lineval(config, le_data_ae_s_nd, 'ae_s_nonden_')
...
plots.plot_usl(config, usl_data_simclr, 'simclr')
plots.plot_lineval(config, le_data_simclr, 'simclr')
