...
plots.plot_usl(config, usl_data_ae_s_d)
plots.plot_lineval(config, le_data_ae_s_d)
...
plots.plot_usl(config, usl_data_ae_s_nd)
plots.plot_lineval(config, le_data_ae_s_nd)
...
plots.plot_usl(config, usl_data_simclr)
plots.plot_lineval(config, le_data_simclr)
